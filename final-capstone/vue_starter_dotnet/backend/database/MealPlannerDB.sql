...
-- Recipe #2   https://www.food.com/recipe/jo-mamas-world-famous-spaghetti-22782
	...
	INSERT INTO recipe(name,  instructions, vegan, vegetarian, gluten_free, cook_time_in_mins, prep_time_in_mins, serves, difficulty, category) VALUES ('World Famous Spaghetti',  
...
WHERE name = 'World Famous Spaghetti'
